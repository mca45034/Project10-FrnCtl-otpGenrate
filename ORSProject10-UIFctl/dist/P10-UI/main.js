...
/* harmony import */ var _otp_otp_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./otp/otp.component */ "./src/app/otp/otp.component.ts");
...
var routes = [
    ...
    { path: 'changepassword',
        ...
        path: 'otp',
        component: _otp_otp_component__WEBPACK_IMPORTED_MODULE_36__["OtpComponent"]
    }
];
...
/* harmony import */ var _otp_otp_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./otp/otp.component */ "./src/app/otp/otp.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _otp_otp_component__WEBPACK_IMPORTED_MODULE_48__["OtpComponent"],
            ],
            imports: [
...
var BaseListCtl = /** @class */ (function (_super) {
    ...
    BaseListCtl.prototype.EmptyFeild = function () {
        if (this.form.firstName == ("") && this.form.lastName == ("") && this.form.roleId == ("")) {
            this.form.messageError = "Please Fill Atleast one search field";
        }
    };
    //   deleteMany(){
...
var BaseCtl = /** @class */ (function () {
    ...
    BaseCtl.prototype.preloads = function () {
        var self = this;
        this.serviceLocator.httpService.get('http://localhost:8084/User/preloads', function (res) {
    ...
    LoginComponent.prototype.signIn = function () {
        ...
        this.httpService.post(this.endpoint + "/login", this.form, function (res) {
            ...
            if (requestedUrl != null && requestedUrl != '') {
                this.localStorage.setItem("uri", requestedUrl);
...
module.exports = "<app-navbar #one></app-navbar>\n\n<style>\n  #nnn{\n    background: none;\n    border: none;\n  }\n  \n  </style>\n\n<style type=\"text/css\">\n.log1 {\n    padding-top: 13%; \n  }\n.grad{\n   background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237)); \n  /* background-image: linear-gradient(to bottom right,purple,pink,blue); */\n  background-repeat: no repeat;\n  background-size: 100%;\n  padding-bottom: 10px;\n}\n</style>\n<form align=\"center\">\n\n  <div class=\"row \" style=\"padding-top: 8%; padding-bottom: 8%;\nbackground: url(assets/files/62.jpg) no-repeat center center;\n   background-attachment: fixed;\nbackground-size: 225vh;width:auto;\n  height: 105vh;\">\n\n  <div class=\"col-sm-4\"></div>\n  <div class=\"col-sm-4\">\n    <div class=\"card input-group-addon grad\">\n      <div class=\"card-body\">\n        \n        <form>\n          <div style=\"text-align: center;\">\n            <!-- <h1 class=\"text-primary font-weight-bold\">Cheak email enter Code</h1> -->\n          </div>\n\n\n\n\n              <div align=\"center\">  \n                <table>\n                     <h5><font color=\"red\">{{form.message}}</font></h5>\n                   <tr>\n                    <th>Enter code<font color=\"red\">*</font></th>\n                     <td> <input type=\"text\" name=\"codeId\" (keypress)=\"limitInput($event, 4)\" [(ngModel)]=\"form.codeId\" class=\"form-control\"\n                      placeholder=\"{{'Enter code' | translate}}\"> </td>\n                     <span  *ngIf=\"inputerror.codeId != null\"\n                     class=\"alertRedColor\" style=\" color: red;\" > {{'please enter code'| translate}} </span>\n          \n                       </tr>\n      \n                      <tr>\n                         <th></th>\n                          <td> <button (click)=\"submit()\" [disabled]=\"!validate()\"  class=\"btn btn-md btn-success\">\n                            {{'submit' | translate}}</button>  &nbsp;&nbsp;\n                            <button (click)=\"cancel()\" class=\"btn btn-md btn-warning\">\n                              {{'Cancel' | translate}}</button>\n                          \n                          </td>\n                            \n                           &nbsp;&nbsp;\n                        </tr>\n                 </table>\n              </div>\n  \n         </form>\n      </div>\n    </div>\n  </div>\n  </div>\n</form>\n\n<app-footer></app-footer>"
...
var OtpComponent = /** @class */ (function () {
    function OtpComponent(httpService, dataValidator, router, cookieService, route, serviceLocator) {
        ...
        this.route = route;
        this.serviceLocator = serviceLocator;
        this.endpoint = "http://localhost:8084/Code";
        this.form = {
            error: false,
            message: '',
            codeId: '',
    ...
    OtpComponent.prototype.limitInput = function (event, maxLength) {
        var target = event.target;
        var value = target.value;
        if (value.length >= maxLength) {
            event.preventDefault();
    ...
    OtpComponent.prototype.submit = function () {
        ...
        this.httpService.post(this.endpoint + "/CodeOTP", this.form, function (res) {
            ...
            if (_self.dataValidator.isTrue(res.success)) {
                ...
                //   console.log(res.result.data.id + 'sessionId set ----');
                //   console.log(res.result.token + '  Token set ----');
                var URL_1 = localStorage.getItem('url');
                if (URL_1 != null && URL_1 != '') {
                    _self.router.navigateByUrl(URL_1);
                }
                else {
                    _self.router.navigateByUrl('dashboard');
                }
...
var UserListComponent = /** @class */ (function (_super) {
    ...
    function UserListComponent(locator, route, httpClient, router) {
        var _this = _super.call(this, locator.endpoints.USER, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
        ...
        _this.isValidfirstNameInput = true;
        _this.isValidlastNameInputs = true;
    ...
    UserListComponent.prototype.limitInputw = function (event, maxLength) {
        var target = event.target;
        var value = target.value;
        if (value.length >= maxLength) {
            event.preventDefault();
    ...
    UserListComponent.prototype.formField = function (event, field) {
        ...
        switch (field) {
            case 'firstName':
                ...
                break;
            case 'lastName':
                var containsNonAlphabetics = /[^\sa-zA-Z]/.test(value);
    ...
    UserListComponent.prototype.preloads = function () {
        var self = this;
        this.serviceLocator.httpService.get('http://localhost:8084/User/preloads', function (res) {
            self.form.preloads = res.result;
        });
...
module.exports = __webpack_require__(/*! D:\proect10_FrontCtl-main\proect10_FrontCtl-main\ORSProject10-UIFctl\src\main.ts */"./src/main.ts");
